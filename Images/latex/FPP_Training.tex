...
\begin{itemize}
 ...
 \vspace{1em}
 \item[] \myhead{AWACS}
 \item E-2D Wizard (Overhead Stennis, Angels 20)
 \begin{itemize}
...
\end{itemize}
\begin{center}
 \includegraphics[width=0.7\linewidth]{../_kneeboard/A2A_Drones.png}
\end{center}
%
% ---------------------------------------------------------------------------------------------------
\newpage
